     ...
     lg:px-32 w-full overflow-hidden' id ='Testimonials'>
      ...
      '>Customer
        <span className='underline underline-offset-4 decoration-1 under font-light'>
         ...
         <p className='text-gray-500 max-w-80 text-center mb-12 mx-auto'>Real stories from Those Who found Home </p>
            <div className='flex flex-wrap justify-center gap-8'>
                ...
                {testimonialsData.map((testimonial, index) => (
                    ...
                    shadow-lg rounded px-8 py-12 text-center'>
                        <img src={testimonial.image} className='w-20 h-20 mx-auto rounded-full mb-4' 
                        alt={testimonial.alt} />
